copy src\FluentBuild.BuildExe\bin\Debug\fb.exe tools\fluentbuild\
copy src\FluentBuild.BuildExe\bin\Debug\FluentBuild.dll tools\fluentbuild\
...
copy src\FluentBuild.BuildExe\bin\Debug\FluentBuild.dll C:\Projects\FluentBuildTestApplications\FluentBuild-Current
